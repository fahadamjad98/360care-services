    ...
    residential: [
      {
        ...
        description: "Complete electrical wiring solutions for new installations and upgrades to existing systems",
        icon: "🔌",
        features: ["New home wiring", "Rewiring old properties", "Circuit upgrades", "Panel replacements"]
      },
      {
        title: "Lighting Solutions",
        description: "Modern lighting installations including LED upgrades, smart lighting, and decorative fixtures",
        icon: "💡",
        features: ["LED conversions", "Smart lighting systems", "Chandelier installation", "Outdoor lighting"]
      },
      {
        title: "Power Solutions",
        description: "Electrical outlet installations, power distribution, and surge protection systems",
        icon: "⚡",
        features: ["Additional outlets", "USB charging points", "Surge protectors", "Generator connections"]
      }
    ],
    commercial: [
      {
        ...
        icon: "🏢",
        features: ["Office wiring", "Data center power", "Emergency lighting", "Fire alarm systems"]
      },
      {
        title: "Industrial Systems",
        description: "Heavy-duty electrical installations for industrial facilities and manufacturing units",
        icon: "🏭",
        features: ["Motor installations", "Control panels", "High-voltage systems", "Safety systems"]
      },
      {
        title: "Maintenance Contracts",
        description: "Ongoing electrical maintenance and inspection services for commercial properties",
        icon: "📋",
        features: ["Regular inspections", "Preventive maintenance", "Emergency repairs", "Compliance audits"]
      }
    ]
  };

  const emergencyTypes = [
    { type: "Power Outage", description: "Complete or partial power loss", icon: "🔴", urgency: "Critical" },
    { type: "Electrical Fire Risk", description: "Burning smell or sparks", icon: "🔥", urgency: "Critical" },
    { type: "Shock Hazard", description: "Electric shocks from outlets", icon: "⚠️", urgency: "High" },
    { type: "Circuit Overload", description: "Frequent breaker trips", icon: "🔄", urgency: "Medium" }
  ];
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-yellow-600 via-amber-600 to-orange-600 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <h1 className={`${title()} text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-white to-yellow-100 bg-clip-text text-transparent`}>
              Electrical Services
            </h1>
            <p className="text-xl md:text-2xl text-yellow-100 max-w-3xl mx-auto leading-relaxed mb-8">
              Safe, reliable, and compliant electrical solutions for Dubai's residential and commercial properties
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-gradient-to-r from-red-500 to-red-600 rounded-2xl p-8 text-white mb-16">
          <div className="flex items-center justify-center mb-6">
            ...
            <div>
              <h2 className="text-3xl font-bold mb-2">Electrical Safety First</h2>
              <p className="text-lg">Licensed electricians • Dubai Municipality approved • Safety guaranteed</p>
            </div>
          </div>
          <div className="grid md:grid-cols-3 gap-6 text-center">
            <div className="bg-white/20 rounded-lg p-4">
              <div className="text-2xl font-bold mb-2">DEWA Approved</div>
              <div className="text-sm">Certified by Dubai Electricity & Water Authority</div>
            </div>
            <div className="bg-white/20 rounded-lg p-4">
              <div className="text-2xl font-bold mb-2">Licensed</div>
              <div className="text-sm">Qualified electricians with proper certifications</div>
            </div>
            <div className="bg-white/20 rounded-lg p-4">
              <div className="text-2xl font-bold mb-2">Insured</div>
              <div className="text-sm">Full insurance coverage for your protection</div>
            </div>
          </div>
        </div>
        ...
        {/* Service Categories */}
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Our Electrical Services</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services[activeCategory].map((service, index) => (
              <div key={index} className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 transform hover:-translate-y-1">
                ...
                <button className="w-full mt-4 bg-yellow-600 hover:bg-yellow-700 text-white py-2 rounded-lg font-semibold transition-colors duration-300">
                  Learn More
                </button>
              </div>
            ))}
        ...
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Emergency Electrical Issues</h2>
          <div className="bg-gray-900 rounded-2xl p-8 text-white mb-8">
            <div className="text-center mb-8">
              <div className="text-6xl mb-4">🚨</div>
              <h3 className="text-2xl font-bold mb-4">24/7 Emergency Electrician</h3>
              <p className="text-lg text-gray-300">Electrical emergencies don't wait. Neither do we. Available 24/7 for urgent electrical issues.</p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              {emergencyTypes.map((emergency, index) => (
                <div key={index} className={`bg-gray-800 rounded-lg p-4 border-l-4 ${
                  emergency.urgency === 'Critical' ? 'border-red-500' : 
                  emergency.urgency === 'High' ? 'border-yellow-500' : 'border-blue-500'
                }`}>
                  <div className="text-2xl mb-2">{emergency.icon}</div>
                  <h4 className="font-semibold mb-2">{emergency.type}</h4>
                  <p className="text-sm text-gray-400 mb-2">{emergency.description}</p>
                  <span className={`text-xs px-2 py-1 rounded-full ${
                    emergency.urgency === 'Critical' ? 'bg-red-500' : 
                    emergency.urgency === 'High' ? 'bg-yellow-500' : 'bg-blue-500'
                  }`}>
                    {emergency.urgency}
                  </span>
                </div>
        ...
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Electrical Safety Inspections</h2>
          <div className="bg-gradient-to-r from-blue-600 to-cyan-600 rounded-2xl p-8 text-white">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-bold mb-4">Why Regular Inspections Matter</h3>
                <p className="text-lg mb-6">
                  Dubai's electrical codes require regular inspections to ensure safety and compliance. 
                  Our certified electricians provide thorough inspections and detailed reports.
                </p>
        ...
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Common Electrical Issues in Dubai</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={index} className="bg-white rounded-lg p-6 shadow-md border border-gray-200">
                ...
                <p className="text-sm text-green-600"><strong>Solution:</strong> {issue.solution}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Smart Home Electrical Solutions</h2>
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-8 text-white">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div>
                <p className="text-lg mb-6">
                  Transform your Dubai home into a smart, efficient, and secure living space with our modern electrical solutions.
                </p>
        ...
        {/* Pricing Section */}
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Service Packages</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
              ...
              <div key={index} className={`bg-white rounded-xl p-6 shadow-lg border-2 ${pkg.popular ? 'border-amber-500 transform scale-105' : 'border-gray-200'} relative`}>
                {pkg.popular && (
        ...
        <div className="text-center bg-gray-50 rounded-2xl p-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Need an Electrician?</h2>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Don't take risks with electrical work. Contact our certified electricians for safe, reliable, and compliant electrical services in Dubai.
          </p>
