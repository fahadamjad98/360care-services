...
export default function PaintingServicesPage() {
  const [activeService, setActiveService] = useState<'interior' | 'exterior'>('interior');

  const services = {
    interior: [
      {
        title: "Interior Wall Painting",
        description: "Professional interior painting for homes, offices, and commercial spaces with premium paints",
        icon: "🎨",
        features: ["All room types", "Color consultation", "Premium paints", "Furniture protection"]
      },
      {
        title: "Ceiling Painting",
        description: "Specialized ceiling painting services including textured and decorative finishes",
        icon: "🏠",
        features: ["Smooth finishes", "Textured ceilings", "Stain coverage", "Height accessibility"]
      },
      {
        title: "Decorative Painting",
        description: "Custom decorative painting including murals, accent walls, and artistic finishes",
        icon: "🖼️",
        features: ["Custom murals", "Accent walls", "Faux finishes", "Artistic designs"]
      }
    ],
    exterior: [
      {
        title: "Exterior House Painting",
        description: "Complete exterior painting services using weather-resistant paints for Dubai's climate",
        icon: "🏘️",
        features: ["Weather protection", "UV resistance", "Moisture barriers", "Long-lasting finish"]
      },
      {
        title: "Building Facades",
        description: "Professional facade painting for commercial buildings and high-rise structures",
        icon: "🏢",
        features: ["High-rise access", "Safety equipment", "Commercial grade paints", "Scheduled maintenance"]
      },
      {
        title: "Outdoor Structures",
        description: "Painting services for fences, gates, outdoor furniture, and recreational areas",
        icon: "🌳",
        features: ["Metal structures", "Wood protection", "Pool areas", "Garden features"]
      }
    ]
  };

  const urgentIssues = [
    { issue: "Water Damage Stains", description: "Ceiling or wall water stains", icon: "💧", severity: "Critical" },
    { issue: "Peeling Paint", description: "Paint peeling off walls", icon: "🔨", severity: "High" },
    { issue: "Mold Growth", description: "Mold spots on painted surfaces", icon: "🦠", severity: "Critical" },
    { issue: "Fading Colors", description: "Sun-damaged exterior paint", icon: "☀️", severity: "Medium" }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-orange-100 max-w-3xl mx-auto leading-relaxed mb-8">
              Transform your space with expert painting services in Dubai - interior, exterior, and decorative solutions
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-yellow-500 hover:bg-yellow-600 text-white px-8 py-3 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg">
                Get Free Quote
              </button>
              <button className="bg-white hover:bg-gray-100 text-orange-600 px-8 py-3 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg">
                Color Consultation
              </button>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-gradient-to-r from-red-500 to-orange-500 rounded-2xl p-8 text-white mb-16">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-4">Dubai's Painting Challenges</h2>
              <p className="text-lg mb-6">
                Dubai's extreme climate, sandstorms, and intense UV radiation create unique challenges for paint durability that require specialized knowledge and materials.
              </p>
            ...
            <div className="text-center">
              ...
              <div className="text-xl font-semibold">We use climate-resistant paints</div>
            </div>
          </div>
        </div>
        ...
        {/* Service Categories */}
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Our Painting Services</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services[activeService].map((service, index) => (
              <div key={index} className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 transform hover:-translate-y-1">
                ...
                <button className="w-full mt-4 bg-orange-600 hover:bg-orange-700 text-white py-2 rounded-lg font-semibold transition-colors duration-300">
                  Get Quote
                </button>
              </div>
            ))}
        ...
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Urgent Painting Issues</h2>
          <div className="bg-gray-900 rounded-2xl p-8 text-white mb-8">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-gray-300 mb-6">
                Some painting issues require immediate attention to prevent further damage. Our rapid response team can handle urgent painting needs.
              </p>
              <div className="flex justify-center space-x-8 text-center">
                ...
                <div className="bg-gray-800 rounded-lg p-4">
                  <div className="text-2xl font-bold text-yellow-400">Licensed</div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              {urgentIssues.map((issue, index) => (
                <div key={index} className={`bg-gray-800 rounded-lg p-4 border-l-4 ${
                  ...
                  issue.severity === 'High' ? 'border-yellow-500' : 'border-blue-500'
                }`}>
                  ...
                  <span className={`text-xs px-2 py-1 rounded-full ${
                    ...
                    issue.severity === 'High' ? 'bg-yellow-500' : 'bg-blue-500'
                  }`}>
                    {issue.severity}
                  </span>
                </div>
        ...
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Common Painting Issues in Dubai</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={index} className="bg-white rounded-lg p-6 shadow-md border border-gray-200">
                ...
                <p className="text-sm text-orange-600"><strong>Solution:</strong> {issue.solution}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Paint Types & Brands */}
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Premium Paint Brands</h2>
          <div className="bg-gradient-to-r from-orange-600 to-red-600 rounded-2xl p-8 text-white">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-bold mb-4">Quality Paints for Dubai Climate</h3>
                <p className="text-lg mb-6">
                  We use only premium paint brands specifically chosen for Dubai's challenging climate conditions, ensuring long-lasting and beautiful results.
                </p>
        ...
        {/* Painting Packages */}
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Painting Packages</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                name: "Basic Paint",
              ...
              <div key={index} className={`bg-white rounded-xl p-6 shadow-lg border-2 ${pkg.popular ? 'border-red-500 transform scale-105' : 'border-gray-200'} relative`}>
                {pkg.popular && (
        ...
        {/* Why Choose Us */}
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Why Choose Our Painting Services?</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                title: "Expert Painters",
                description: "Skilled painters with years of experience in Dubai",
                icon: "👨‍🎨"
              },
              {
        ...
        <div className="text-center bg-gray-50 rounded-2xl p-12">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            From interior walls to exterior facades, our professional painters are ready to bring your vision to life with quality and precision.
          </p>
