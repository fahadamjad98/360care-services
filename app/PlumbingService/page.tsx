    ...
    residential: [
      {
        ...
        icon: "🔍",
        features: ["Non-invasive detection", "Hidden leak finding", "Pipe repair", "Water damage prevention"]
      },
      {
        title: "Bathroom & Kitchen Plumbing",
        description: "Complete plumbing solutions for bathrooms and kitchens including fixtures and pipe installations",
        icon: "🚿",
        features: ["Fixture installation", "Pipe fitting", "Drain cleaning", "Water heater service"]
      },
      {
        title: "Emergency Plumbing",
        description: "24/7 emergency plumbing services for burst pipes, major leaks, and urgent repairs",
        icon: "🚨",
        features: ["24/7 availability", "Rapid response", "Emergency repairs", "Damage control"]
      }
    ],
    commercial: [
      {
        title: "Commercial Plumbing",
        description: "Complete plumbing systems for offices, retail spaces, and commercial buildings",
        icon: "🏢",
        features: ["System design", "Installation", "Maintenance", "Compliance checks"]
      },
      {
        title: "Industrial Plumbing",
        description: "Heavy-duty plumbing solutions for industrial facilities and manufacturing plants",
        icon: "🏭",
        features: ["Process piping", "Industrial fixtures", "Waste management", "Safety systems"]
      },
      {
        title: "Preventive Maintenance",
        description: "Regular maintenance programs to prevent costly plumbing failures and ensure smooth operations",
        icon: "🔧",
        features: ["Scheduled inspections", "Preventive repairs", "System optimization", "Cost savings"]
      }
    ]
  };

  const emergencyIssues = [
    { issue: "Burst Pipes", description: "Water flooding from broken pipes", icon: "💥", severity: "Critical" },
    { issue: "Sewage Backup", description: "Sewage coming up drains", icon: "🚫", severity: "Critical" },
    { issue: "No Hot Water", description: "Water heater failure", icon: "🔥", severity: "High" },
    { issue: "Blocked Drains", description: "Complete drain blockage", icon: "🚰", severity: "Medium" }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-cyan-100 max-w-3xl mx-auto leading-relaxed mb-8">
              Expert plumbing solutions for Dubai's residential and commercial properties - from leaks to complete installations
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl p-8 text-white mb-16">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-4">Dubai's Unique Plumbing Challenges</h2>
              <p className="text-lg mb-6">
                Dubai's desert climate, hard water, and modern infrastructure create specific plumbing challenges that require expert knowledge and specialized solutions.
              </p>
            ...
            <div className="text-center">
              ...
              <div className="text-xl font-semibold">We know Dubai's plumbing</div>
            </div>
          </div>
        </div>
        ...
        {/* Service Categories */}
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Our Plumbing Services</h2>
        ...
        {/* Emergency Plumbing */}
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Emergency Plumbing Services</h2>
          <div className="bg-gray-900 rounded-2xl p-8 text-white mb-8">
            <div className="text-center mb-8">
              <div className="text-6xl mb-4">🚨</div>
              <h3 className="text-2xl font-bold mb-4">24/7 Emergency Plumber</h3>
              <p className="text-lg text-gray-300 mb-6">
                Plumbing emergencies can cause serious damage. Our emergency plumbers are available 24/7 with rapid response times across Dubai.
              </p>
        ...
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Common Plumbing Issues in Dubai</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={index} className="bg-white rounded-lg p-6 shadow-md border border-gray-200">
                ...
                <p className="text-sm text-blue-600"><strong>Solution:</strong> {issue.solution}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Water Quality Solutions</h2>
          <div className="bg-gradient-to-r from-teal-600 to-blue-600 rounded-2xl p-8 text-white">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-bold mb-4">Improve Your Water Quality</h3>
                <p className="text-lg mb-6">
                  Dubai's hard water can damage pipes, fixtures, and appliances. Our water treatment solutions protect your plumbing investment and improve water quality.
                </p>
        ...
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Plumbing Maintenance Packages</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
              ...
              <div key={index} className={`bg-white rounded-xl p-6 shadow-lg border-2 ${pkg.popular ? 'border-teal-500 transform scale-105' : 'border-gray-200'} relative`}>
                {pkg.popular && (
        ...
        {/* Why Choose Us */}
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Why Choose Our Plumbing Services?</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Deep understanding of Dubai's plumbing codes and challenges",
                icon: "🏙️"
              },
              {
                title: "Quality Guarantee",
                description: "All work guaranteed with warranty on parts and labor",
                icon: "✅"
              },
              {
        ...
        <div className="text-center bg-gray-50 rounded-2xl p-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Need a Plumber?</h2>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            From minor leaks to major installations, our expert plumbers are ready to solve your plumbing problems quickly and efficiently.
          </p>
