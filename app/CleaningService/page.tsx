    ...
    residential: [
      {
        ...
        description: "Comprehensive deep cleaning for homes including all rooms, bathrooms, and kitchens",
        icon: "🏠",
        features: ["All rooms covered", "Bathroom sanitization", "Kitchen deep clean", "Furniture dusting"]
      },
      {
        title: "Villa Cleaning",
        description: "Specialized cleaning services for large villas and luxury homes in Dubai",
        icon: "🏰",
        features: ["Multiple floors", "Outdoor areas", "Pool cleaning", "Garden maintenance"]
      },
      {
        title: "Apartment Cleaning",
        description: "Efficient cleaning services tailored for apartments and smaller living spaces",
        icon: "🏢",
        features: ["Compact space expertise", "Balcony cleaning", "Quick turnaround", "Flexible scheduling"]
      }
    ],
    commercial: [
      {
        title: "Office Cleaning",
        description: "Professional office cleaning services for businesses, co-working spaces, and corporate buildings",
        icon: "🏢",
        features: ["Daily maintenance", "Sanitization", "Carpet cleaning", "Window cleaning"]
      },
      {
        title: "Restaurant Cleaning",
        description: "Specialized cleaning for restaurants, cafes, and food service establishments",
        icon: "🍽️",
        features: ["Kitchen deep clean", "Food safety compliance", "Grease removal", "Equipment sanitization"]
      },
      {
        title: "Retail Store Cleaning",
        description: "Cleaning services for retail spaces, showrooms, and shopping centers",
        icon: "🛍️",
        features: ["Customer area focus", "Display cleaning", "Floor maintenance", "Restroom sanitization"]
      }
    ]
  };

  const urgentIssues = [
    { issue: "Mold Growth", description: "Mold and mildew in humid areas", icon: "🦠", severity: "Critical" },
    { issue: "Pest Infestation", description: "Cleaning after pest control treatment", icon: "🐛", severity: "High" },
    { issue: "Water Damage", description: "Flood or leak cleanup", icon: "💧", severity: "Critical" },
    { issue: "Odor Removal", description: "Strong odors requiring immediate attention", icon: "🫧", severity: "High" }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed mb-8">
              Pristine cleaning solutions for homes and businesses in Dubai - residential, commercial, and specialized services
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-gradient-to-r from-cyan-500 to-blue-500 rounded-2xl p-8 text-white mb-16">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-4">Dubai's Cleaning Challenges</h2>
              <p className="text-lg mb-6">
                Dubai's desert environment, high humidity, and urban pollution create unique cleaning challenges that require specialized knowledge and equipment.
              </p>
            ...
            <div className="text-center">
              ...
              <div className="text-xl font-semibold">We handle Dubai's unique challenges</div>
            </div>
          </div>
        </div>
        ...
        {/* Service Categories */}
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Our Cleaning Services</h2>
        ...
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Emergency Cleaning Services</h2>
          <div className="bg-gray-900 rounded-2xl p-8 text-white mb-8">
            <div className="text-center mb-8">
              <div className="text-6xl mb-4">⚡</div>
              <h3 className="text-2xl font-bold mb-4">Rapid Response Cleaning</h3>
              <p className="text-lg text-gray-300 mb-6">
                Some cleaning situations require immediate attention to prevent health risks and further damage. Our emergency team is ready 24/7.
              </p>
        ...
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Common Cleaning Challenges in Dubai</h2>
        ...
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Professional Cleaning Products</h2>
          <div className="bg-gradient-to-r from-blue-600 to-cyan-600 rounded-2xl p-8 text-white">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-bold mb-4">Eco-Friendly & Effective Solutions</h3>
                <p className="text-lg mb-6">
                  We use premium, eco-friendly cleaning products that are safe for your family and pets while being tough on dirt and germs.
                </p>
        ...
        {/* Why Choose Us */}
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Why Choose Our Cleaning Services?</h2>
        ...
        <div className="text-center bg-gray-50 rounded-2xl p-12">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            From homes to offices, our professional cleaning team is ready to make your space shine with attention to detail and care.
          </p>
