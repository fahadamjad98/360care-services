...
export default function ApplianceRepairPage() {
  const [activeService, setActiveService] = useState<'home' | 'commercial'>('home');

  const services = {
    home: [
      {
        title: "Washing Machine Repair",
        description: "Expert repair for all washing machine brands including Samsung, LG, Bosch, and Whirlpool",
        icon: "🔧",
        features: ["All brands serviced", "Drum replacement", "Motor repair", "Control board fixes"]
      },
      {
        title: "Refrigerator Repair",
        description: "Complete refrigerator and freezer repair services including cooling system restoration",
        icon: "❄️",
        features: ["Cooling system repair", "Compressor service", "Thermostat replacement", "Ice maker fixes"]
      },
      {
        title: "Dishwasher Repair",
        description: "Professional dishwasher repair and maintenance for optimal cleaning performance",
        icon: "🍽️",
        features: ["Pump replacement", "Spray arm cleaning", "Door seal repair", "Control panel fixes"]
      }
    ],
    commercial: [
      {
        title: "Commercial Laundry",
        description: "Heavy-duty laundry equipment repair for hotels, hospitals, and laundromats",
        icon: "🏢",
        features: ["Industrial washers", "Commercial dryers", "Coin-operated machines", "Maintenance contracts"]
      },
      {
        title: "Restaurant Equipment",
        description: "Kitchen appliance repair for restaurants, cafes, and food service establishments",
        icon: "🍳",
        features: ["Commercial refrigeration", "Ovens and ranges", "Ice machines", "Food processors"]
      },
      {
        title: "Office Appliances",
        description: "Repair and maintenance of office appliances including water coolers and coffee machines",
        icon: "☕",
        features: ["Water dispensers", "Coffee machines", "Microwave ovens", "Mini fridges"]
      }
    ]
  };

  const emergencyIssues = [
    { issue: "Flooding Washer", description: "Water leaking everywhere", icon: "💧", severity: "Critical" },
    { issue: "Fridge Not Cooling", description: "Complete cooling failure", icon: "🔥", severity: "Critical" },
    { issue: "Sparking Appliance", description: "Electrical issues or sparks", icon: "⚡", severity: "Critical" },
    { issue: "Strange Noises", description: "Unusual sounds from appliance", icon: "🔊", severity: "High" }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed mb-8">
              Expert appliance repair services in Dubai - from washing machines to refrigerators, we fix them all
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl p-8 text-white mb-16">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-4">Dubai's Appliance Challenges</h2>
              <p className="text-lg mb-6">
                Dubai's extreme climate, power fluctuations, and dust exposure create unique challenges for home appliances that require specialized repair expertise.
              </p>
            ...
            <div className="text-center">
              ...
              <div className="text-xl font-semibold">We understand Dubai's conditions</div>
            </div>
          </div>
        </div>
        ...
        {/* Service Categories */}
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Our Repair Services</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services[activeService].map((service, index) => (
              <div key={index} className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 transform hover:-translate-y-1">
                ...
                <button className="w-full mt-4 bg-purple-600 hover:bg-purple-700 text-white py-2 rounded-lg font-semibold transition-colors duration-300">
                  Book Repair
                </button>
              </div>
            ))}
        ...
        {/* Emergency Repairs */}
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Emergency Appliance Repair</h2>
          <div className="bg-gray-900 rounded-2xl p-8 text-white mb-8">
            <div className="text-center mb-8">
              <div className="text-6xl mb-4">🚨</div>
              <h3 className="text-2xl font-bold mb-4">24/7 Emergency Technician</h3>
              <p className="text-lg text-gray-300 mb-6">
                Appliance emergencies can disrupt your daily life. Our certified technicians are available 24/7 with rapid response times across Dubai.
              </p>
              <div className="flex justify-center space-x-8 text-center">
                <div className="bg-gray-800 rounded-lg p-4">
                  <div className="text-2xl font-bold text-purple-400">45 min</div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              {emergencyIssues.map((emergency, index) => (
                <div key={index} className={`bg-gray-800 rounded-lg p-4 border-l-4 ${
                  ...
                  emergency.severity === 'High' ? 'border-yellow-500' : 'border-blue-500'
                }`}>
                  ...
                  <span className={`text-xs px-2 py-1 rounded-full ${
                    ...
                    emergency.severity === 'High' ? 'bg-yellow-500' : 'bg-blue-500'
                  }`}>
                    {emergency.severity}
                  </span>
                </div>
        ...
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Common Appliance Issues in Dubai</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={index} className="bg-white rounded-lg p-6 shadow-md border border-gray-200">
                ...
                <p className="text-sm text-purple-600"><strong>Solution:</strong> {issue.solution}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Brands We Service */}
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Brands We Service</h2>
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-bold mb-4">All Major Appliance Brands</h3>
                <p className="text-lg mb-6">
                  Our certified technicians are trained to service all major appliance brands with genuine parts and manufacturer-approved repair methods.
                </p>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className={`bg-white rounded-xl p-6 shadow-lg border-2 ${pkg.popular ? 'border-purple-500 transform scale-105' : 'border-gray-200'} relative`}>
                {pkg.popular && (
        ...
        {/* Why Choose Us */}
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">Why Choose Our Repair Service?</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              {
                title: "Genuine Parts",
                description: "Only authentic manufacturer parts for lasting repairs",
                icon: "⚙️"
              },
              {
        ...
        <div className="text-center bg-gray-50 rounded-2xl p-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Need Appliance Repair?</h2>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            From washing machines to refrigerators, our expert technicians are ready to fix your appliances quickly and efficiently.
          </p>
